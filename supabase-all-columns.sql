-- ============================================================
-- PADELGABON — Garantit que TOUTES les tables ont TOUTES les colonnes
-- 100% sans risque : que des "add column if not exists" (n'enlève rien)
...
alter table public.coaches add column if not exists clubs jsonb default '[]'::jsonb;
...
alter table public.tournaments add column if not exists club_name text default '';
